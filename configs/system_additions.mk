...
PRODUCT_COPY_FILES += \
    vendor/solo/prebuilt/etc/init.abc.rc:root/init.abc.rc
...
PRODUCT_COPY_FILES += \
    vendor/solo/prebuilt/bin/fstrim:system/bin/fstrim
...
$(call inherit-product-if-exists, vendor/solo/prebuilt/prebuilt.mk)
